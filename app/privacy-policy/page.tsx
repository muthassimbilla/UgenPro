...
export const metadata: Metadata = {
  title: "Privacy Policy - UGen Pro",
  description: "Learn how UGen Pro protects your privacy and handles your personal data.",
  keywords: "privacy policy, data protection, GDPR, user privacy",
  openGraph: {
    title: "Privacy Policy - UGen Pro",
    description: "Learn how UGen Pro protects your privacy and handles your personal data.",
    type: "website",
    url: "https://ugenpro.site/privacy-policy",
  },
  alternates: {
    canonical: "https://ugenpro.site/privacy-policy",
  },
}
...
const PrivacyPolicyPage = memo(function PrivacyPolicyPage() {
  return (
    <div className="min-h-screen bg-background">
      <Navigation activeSection="privacy" />
