...
export const metadata: Metadata = {
  title: "Terms of Service - UGen Pro",
  description: "Read the terms and conditions for using UGen Pro services.",
  keywords: "terms of service, terms and conditions, user agreement",
  openGraph: {
    title: "Terms of Service - UGen Pro",
    description: "Read the terms and conditions for using UGen Pro services.",
    type: "website",
    url: "https://ugenpro.site/terms-of-service",
  },
  alternates: {
    canonical: "https://ugenpro.site/terms-of-service",
  },
}
...
const TermsOfServicePage = memo(function TermsOfServicePage() {
  return (
    <div className="min-h-screen bg-background">
      <Navigation activeSection="terms" />
        ...
        <div className="container mx-auto px-4 py-8 pt-24 max-w-4xl">
          ...
          <Card className="mb-6">
            ...
            <CardContent>
              <p className="text-muted-foreground leading-relaxed">
                These Terms of Service ("Terms") govern your use of UGen Pro's website and services. By accessing or
          ...
          <Card className="mb-6">
            ...
            <CardContent>
              <p className="text-muted-foreground leading-relaxed">
                ...
                through our platform. Continued use of our services after changes constitutes acceptance of the new
                Terms.
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <div className="space-y-2">
                <p>
                  <strong>Email:</strong> ugenpro.info@gmail.com
                </p>
                <p>
                  <strong>Website:</strong> https://ugenpro.site
                </p>
                <p>
          ...
          <div className="text-center mt-8 pt-6 border-t border-border">
            <p className="text-sm text-muted-foreground">
              These Terms of Service are effective as of {new Date().toLocaleDateString()} and govern your use of UGen
              Pro services. By using our platform, you acknowledge that you have read, understood, and agree to be bound
              by these terms.
            </p>
          </div>
        </div>
