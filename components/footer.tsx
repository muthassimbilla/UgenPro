          ...
          <div className="bg-white/90 dark:bg-gray-900/90 backdrop-blur-xl rounded-3xl p-8 hover:shadow-2xl hover:shadow-[#4a9fff]/20 transition-all duration-300 hover:-translate-y-2 border-2 border-[#4a9fff]/30 dark:border-[#4a9fff]/40 shadow-lg">
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link
                  href="/privacy-policy"
                  className="text-sm text-muted-foreground hover:text-purple-500 transition-all font-medium block py-2 px-3 rounded-xl hover:bg-purple-500/10 hover:text-purple-500 group"
                >
                  <span className="inline-flex items-center gap-2">
              ...
              <li>
                <Link
                  ...
                  className="text-sm text-muted-foreground hover:text-indigo-500 transition-all font-medium block py-2 px-3 rounded-xl hover:bg-indigo-500/10 hover:text-indigo-500 group"
                >
                  <span className="inline-flex items-center gap-2">
